...
<section class="profile_page pages">
	<h1>new york city halloween parties 2015</h1>

	<ul class="page_nav">
		<li class="page_link"><a href="#">Buy tickets</a></li>
...
<div class="info row">
	<div class="party_info">
		...
		<div class="party_location">Doors Open at <?= $event->when->door_time->formatted?>, <?= $event->where->address1?></div>
	</div>
	...
	<div class="ticket_info">
		<div class="heading">Tickets<span class="page_top"><a href="#top">Back to Top</a></span></div>
	<?php foreach ($event->tickets as $tickets) { ?>
		<div class="ticket_row">
			...
			<div class="right_col">
				...
				<a href="<?= $event->buy_url?>" target="_blank"><div class="buy_tickets">buy tickets</div></a>
			</div>
		</div>
	<?php } ?>
	</div>
	...
	<!-- <div class="music_crowd">
		<div class="heading">Music & Crowd<span class="page_top"><a href="#top">Back to Top</a></span></div>
		<div class="mc_row">
